...
public class CategoryController {
    ...
    public Page4Navigator<Category> list(PageQuery pageQuery) throws Exception {
        Page4Navigator<Category> page = categoryService.list(pageQuery.getStart(), pageQuery.getSize(), pageQuery.getNavigatePages());
