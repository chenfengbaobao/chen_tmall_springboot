...
/**
 * @Author : haifeng.wu
 * @Date : 2020-08-05 22:39:20
 */

@Getter
@Setter
public class Page4Navigator2<T> {
     ...
     */
    public Page4Navigator2() {

    }

    public Page4Navigator2(PageInfo<T> pageFromJPA) {
        this.pageFromJPA = pageFromJPA;
    }

    public Page4Navigator2(PageInfo<T> pageFromJPA, int navigatePages) {
